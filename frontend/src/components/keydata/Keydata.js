...
function Keydata({ type, value }) {
  ...
  switch (type) {
    case "calorie":
      ...
      if (value !== undefined) {
        let numberToChange = value.toString().split("");
      ...
      content = (
        <div className="right_container ">
          <div className="right_container_keyData">
      ...
      content = (
        <div className="right_container ">
          <div className="right_container_keyData">
            ...
            <div className="right_container_proteine_info">
              <p>{value}g</p>
              <p>Proteines</p>
            </div>
          </div>
      ...
      content = (
        <div className="right_container ">
          <div className="right_container_keyData">
            ...
            <div className="right_container_lipide_info">
              <p>{value}g</p>
              <p>Lipides</p>
            </div>
          </div>
